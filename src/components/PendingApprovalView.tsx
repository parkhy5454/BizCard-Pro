  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 text-center shadow-2xl">
        ...
        <h1 className="text-lg font-bold text-slate-100 mb-2">관리자 승인 대기 중입니다</h1>
        <p className="text-sm text-slate-400 leading-relaxed mb-6">
          <span className="text-slate-200 font-medium">{currentUser.companyName || '회사'}</span> 소속으로 가입 신청이 접수되었습니다.
          회사 관리자가 승인하면 명함, 프로젝트 등 회사 데이터를 이용하실 수 있어요.
        </p>
        <div className="flex items-center justify-center gap-2 text-xs text-slate-500 bg-slate-950/60 border border-slate-800 rounded-xl px-3 py-2.5 mb-6">
