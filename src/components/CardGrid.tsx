      ...
      <div className="max-w-md mx-auto relative">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-16 py-3 rounded-2xl bg-slate-900 border border-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-200 transition-all placeholder:text-slate-500 shadow-inner"
          />
          {searchQuery && (
            <button 
